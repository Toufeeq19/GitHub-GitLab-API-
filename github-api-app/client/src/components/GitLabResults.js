...
export default function GitLabResults({
  ...
  // If userProfiles is defined but userFound for GitLab (index 1) is false
    ...
    // Renderes a card component indicating that no user is found on GitLab
    return (
      <div>
  ...
  // If userProfiles are defined and the userFound for GitLab (index 1) is true
  else {
    // Renderes a card component displaying GitLab user information and repositories
    return (
      <div>
        <Card style={{ width: "30rem" }}>
          <Card.Body>
          ...
          <Card.Body>
            ...
            {/* Displays a loading message when repositories are loading otherwise it displays the GitLab repository data */}
