  ...
  return (
    <>
      ...
      <div className="choiceDiv my-5">
        ...
        <div
          className={option ? "choiceItem" : "choiceItem selected"} // Conditionally applies classes based on option state
        ...
        <div
          className={option ? "choiceItem selected" : "choiceItem"} // Conditionally applies classes based on the option state
